    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('analyses.index') }}"><i
                            class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('dashboard') }}"><i
                            class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Sample
                            Dashboard</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('profile.edit') }}"><i
                            class="side-menu__icon fe fe-user"></i><span class="side-menu__label">Profile</span></a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('roles.index') }}"><i
                            class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Roles</span></a>
                </li>
                ...
                <li class="slide">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('logout') }}"
                            ...
                            <span class="side-menu__label">{{ __('Log Out') }}</span>
